...
- refactor [OpenVSX JetbrainsRating PyPiDownloads PackageControl VaadinDirectory] to use `routeEnum` [#12167](https://github.com/badges/shields/issues/12167)
- refactor [Github JsDelivr NpmDownloads NpmStatDownloads GitlabIssues] to use `routeEnum` & add hacktoberfest 2026 [#12166](https://github.com/badges/shields/issues/12166)
